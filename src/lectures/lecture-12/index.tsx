  ...
  return (
    <LectureWrapper id="12" title="The DOM: Tree, Methods & Events">
      ...
      <section>
        ...
        <p>
          So far we have been working with JavaScript in isolation -- logging
          to the console, building objects, writing functions. But the whole
        ...
        <p>
          ...
          the construction crew that can add rooms, tear down walls, and
          repaint -- all while the user is inside.
        </p>
        ...
        <Diagram title="HTML vs DOM">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="bg-indigo-900/30 border border-indigo-500/30 rounded-lg p-4">
              <div className="font-bold text-indigo-300 mb-2">DOM (in memory)</div>
              <ul className="text-sm text-gray-300 space-y-1 list-disc list-inside">
        ...
        <InfoBox type="info">
          ...
          page updates instantly in the browser, but your original .html file
      ...
      <section>
        <h2>The DOM Tree</h2>
        <p>
          Every HTML element becomes a <strong>node</strong> in a tree. The
          root is <code>document</code>, and everything branches from there.
          Nodes have parent-child relationships: a <code>&lt;ul&gt;</code> is
          the <strong>parent</strong> of its <code>&lt;li&gt;</code> children,
          and those <code>&lt;li&gt;</code> elements are{" "}
          <strong>siblings</strong> of each other.
        </p>
        ...
        <Diagram title="A Simple DOM Tree">
          <div className="font-mono text-sm max-w-md mx-auto">
            ...
            <div className="ml-4 border-l border-gray-700 pl-3">
              ...
              <div className="ml-4 border-l border-gray-700 pl-3">
                ...
                <div className="ml-4 text-gray-500">&lt;title&gt; "My Page"</div>
                <div className="text-yellow-300 mt-1">&lt;body&gt;</div>
                <div className="ml-4 border-l border-gray-700 pl-3">
                  <div className="text-green-300">&lt;h1&gt; <span className="text-gray-500">"Hello DOM!"</span></div>
                  <div className="text-green-300">&lt;p&gt; <span className="text-gray-500">"Welcome"</span></div>
                  <div className="text-green-300">&lt;ul&gt;</div>
                  <div className="ml-4 border-l border-gray-700 pl-3">
                    <div className="text-purple-300">&lt;li&gt; <span className="text-gray-500">"Item 1"</span></div>
                    <div className="text-purple-300">&lt;li&gt; <span className="text-gray-500">"Item 2"</span></div>
                    <div className="text-purple-300">&lt;li&gt; <span className="text-gray-500">"Item 3"</span></div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="mt-3 text-xs text-gray-500 text-center">
            body is the PARENT of h1, p, and ul. The h1, p, and ul are SIBLINGS. The li elements are CHILDREN of ul.
          </div>
        </Diagram>
      </section>
      ...
      <section>
        ...
        <Diagram title="Selection Methods">
          <div className="space-y-2">
            {[
              ...
              <div key={item.method} className="bg-gray-800/50 border border-gray-700 rounded-lg p-3">
                <div className="flex flex-wrap items-center gap-2 mb-1">
                  <code className="text-indigo-300 text-sm font-bold">{item.method}</code>
                  <span className="text-xs text-gray-500">&rarr; {item.returns}</span>
                </div>
                <code className="text-xs text-gray-400 block">{item.example}</code>
        ...
        <InfoBox type="tip">
          ...
          in modern code. They accept any CSS selector, making them far more
        ...
        <Diagram title="Content: textContent vs innerHTML">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-green-900/20 border border-green-500/30 rounded-lg p-4">
              <div className="font-bold text-green-300 mb-2">textContent (safe)</div>
              <code className="text-xs text-gray-300 block mb-2">el.textContent = "Hello";</code>
              <div className="text-xs text-gray-400">
                Sets plain text. HTML tags are treated as literal text, not parsed. Always safe from XSS attacks.
              </div>
            </div>
            <div className="bg-yellow-900/20 border border-yellow-500/30 rounded-lg p-4">
              <div className="font-bold text-yellow-300 mb-2">innerHTML (powerful but risky)</div>
              <code className="text-xs text-gray-300 block mb-2">{'el.innerHTML = "<b>Hello</b>";'}</code>
              <div className="text-xs text-gray-400">
                Parses and renders HTML. Never use with user input -- it opens the door to XSS (cross-site scripting) attacks.
              </div>
            </div>
          </div>
        </Diagram>
        ...
        <Diagram title="Styling: inline vs classList">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-red-900/20 border border-red-500/30 rounded-lg p-4">
              <div className="font-bold text-red-300 mb-2">el.style.* (avoid)</div>
              <code className="text-xs text-gray-300 block mb-2">el.style.color = "red";</code>
              <div className="text-xs text-gray-400">
                Inline styles are hard to maintain and override CSS specificity. Use sparingly.
              </div>
            </div>
            <div className="bg-green-900/20 border border-green-500/30 rounded-lg p-4">
              <div className="font-bold text-green-300 mb-2">el.classList.* (prefer)</div>
              ...
              <div className="text-xs text-gray-400">
                Keep your styles in CSS and use JS only to toggle classes. Clean and maintainable.
              </div>
            </div>
          </div>
        </Diagram>
...
console.log("style.*: inline styles, use only when necessary");`}
        ...
        <InfoBox type="tip">
          ...
          your visual styles in CSS and let JavaScript just toggle classes.
      ...
      <section>
        ...
        <p>
          ...
          the page, or remove existing elements. This is the foundation of
          all dynamic content on the web.
        </p>
        ...
        <AnnotatedCode
          ...
          segments={[
            ...
            { code: "\n\n// Step 2: Configure it\n" },
            {
              ...
              annotation: "Set its text content, classes, attributes, or any other properties before adding it to the page.",
              label: "configure",
            },
            { code: "\n" },
...
console.log("dataset.* for custom data-* attributes");`}
      ...
      <section>
        ...
        <p>
          Events are things that happen on a page -- a click, a keypress, a
          form submission, mouse movement. JavaScript lets you{" "}
        ...
        <Diagram title="Common DOM Events">
          <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
            {[
              ...
              <div key={item.event} className="bg-gray-800/50 rounded px-3 py-2">
...
console.log("e.key = which keyboard key was pressed");`}
      ...
      <section>
        ...
        <p>
          ...
          In modern web apps we almost always want to handle the submission
          with JavaScript instead. The <code>e.preventDefault()</code> method
        ...
        <InfoBox type="warning">
          ...
          Without it, the page reloads and you lose everything. This is the
          most common beginner mistake when working with forms.
        </InfoBox>
      </section>
      ...
      <section>
        ...
        <p>
          ...
          -- into a practical example. This is the kind of thing you will
          build constantly as a front-end developer.
        </p>
        ...
        <AnnotatedCode
          ...
          segments={[
            { code: "// 1. Select existing elements\n" },
            {
              ...
              annotation: "Always cache your DOM selections in variables at the top. Querying the DOM is slow, so do it once.",
              label: "select & cache",
            },
            { code: "\n\n// 2. Define the add function\n" },
            {
              code: 'function addTodo() {\n  const text = input.value.trim();\n  if (!text) return;',
              annotation: "Always validate input: trim whitespace and reject empty strings.",
              label: "validate",
            },
            { code: "\n\n" },
            {
              code: '  const li = document.createElement("li");\n  li.textContent = text;',
              annotation: "Create the new element and set its content. Use textContent (not innerHTML) to avoid XSS.",
              label: "create element",
            },
            { code: "\n\n" },
            {
              code: '  const delBtn = document.createElement("button");\n  delBtn.textContent = "X";\n  delBtn.addEventListener("click", () => li.remove());',
              annotation: "Create a delete button and attach a click handler that removes the parent list item.",
              label: "delete button",
            },
            { code: "\n\n" },
            {
              code: "  li.appendChild(delBtn);\n  list.appendChild(li);",
              annotation: "Assemble the pieces: button goes into the list item, then the list item goes into the list.",
            ...
            { code: "// 3. Wire up event listeners\n" },
            {
              ...
              annotation: 'Listen for both button clicks and Enter key presses. Check e.key === "Enter" for keyboard events.',
...
console.log("This is the fundamental DOM workflow!");`}
      ...
      <section>
        <h2>Key Takeaways</h2>
        <ul>
          <li>The DOM is a live tree built from HTML. JS manipulates this tree, not the file.</li>
          <li>Use <code>querySelector</code> / <code>querySelectorAll</code> to select elements with CSS selectors.</li>
          <li>Change text with <code>textContent</code> (safe) or <code>innerHTML</code> (be careful with user input).</li>
          <li>Use <code>classList.add/remove/toggle</code> to change styles -- keep CSS in CSS files.</li>
          <li><code>createElement</code> + <code>appendChild</code> to build elements dynamically.</li>
          <li><code>addEventListener</code> to respond to clicks, keypresses, form submissions, etc.</li>
          <li><code>e.preventDefault()</code> stops default browser behavior (like form page reloads).</li>
        </ul>
      </section>
      ...
      <ExerciseBlock number={1}>
        <p>
          ...
          (Red, Green, Blue) that change the body background color when
          clicked. Add a Reset button that restores the original color. Use{" "}
      ...
      <ExerciseBlock number={3}>
        <p>
          ...
          <code>appendChild</code> to dynamically create card elements for
          each user. Each card should display the name, age, and role, and
          include a "Remove" button that deletes the card when clicked.
        </p>
      </ExerciseBlock>
      ...
      <HomeworkBlock>
        ...
        <ol>
          <li>
            An input field + "Add Student" button that creates new student
            cards dynamically.
          </li>
          <li>
            Each card has: the student's name, an "Edit" button (use{" "}
            <code>prompt()</code> to get the new name), a "Delete" button
            (with <code>confirm()</code> before removing), and a "Highlight"
            toggle button using <code>classList.toggle()</code>.
          </li>
          <li>
