...
const Sidebar = ({ isOpen, onClose }: SidebarProps) => {
  return (
    <>
      ...
      <aside
        className={`fixed top-0 left-0 z-30 h-full w-72 bg-gray-900 text-gray-100 overflow-y-auto transition-transform duration-300 lg:translate-x-0 lg:sticky lg:top-0 ${
